...
\begin{enumerate}[3a)]
    ...
    using \verb|part3.py| and find that a nearly optimal vector within 0.01
    of the optimum is $\mathbf{v}_\text{the} = (-2, 2)$. Increasing the values
    further brings the probabilities closer to the target.
\end{enumerate}
